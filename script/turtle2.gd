...
@export var left_limit: Vector2 = Vector2(2986, 360)
@export var right_limit: Vector2 = Vector2(3080, 360)
...
#func _on_kill_zone_body_entered(body: Node2D) -> void:
	#stomp.monitoring = false


#func _on_kill_zone_body_entered(body: Node2D) -> void:
	#if body.name == "Player" and is_flipped: 
		#stomp.monitoring = true
